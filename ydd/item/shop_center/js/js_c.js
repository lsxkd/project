...
　// 添加文字
  $(".add_fontss").on({
    "tap":function(){
      ...
      $(".item_textarea_keyup").focus();
      $(".item_textarea_keyup").val($(".item_textarea_keyup").val())
      return false;
    }
  })
...
// 商家认证  start
  ...
  $(".times_period,.time_type_period").on({
    "tap":function(){
      ...
      $(".period_selects_pop,.pop_cover_bg").show();
       if($(".change_this").find("input").val() == ""){
          $(".times_selects_pop_item").removeClass("on")
        }else if($(".change_this").find("input").val() == "永久有效"){
          $(".times_selects_pop_item").removeClass("on")
          $(".times_selects_pop_item_01").eq(0).addClass("on")
        }else if($(".change_this").find("input").val() == "固定有效"){
          $(".times_selects_pop_item").removeClass("on")
          $(".times_selects_pop_item_01").eq(1).addClass("on")
        }
    }
  })
  ...
  // 年
  $(".coupon_time_pops .area_select_pops_con_one").on({
    "touchend":function(){
      var ul=$(this).find("ul");
  ...
  // 月
  $(".area_select_pops .area_select_pops_con_two").on({
    "touchend":function(){
      ...
      setTimeout(function(){
        ...
        switch(num){
          ...
          case 11:
            ...
            break;
          case 2:
            var that=$(".area_select_pops  .ul_one");
        ...
        $(".ul_threes",ul.closest(".area_select_pops")).html(three_html);
      },100)

      // 清空日
      $(".ul_threes",$(this).closest('.area_select_pops ')).html("");
    ...
    "tap":function(){
     ...
     var vals=$(".change_this span").html().replace(/\s/g,"").split("至")[0].split(/\D/);       
      ...
      if($(this).hasClass("coupon_time")){
        ...
        var lih=$(".ul_ones li").outerHeight(true)

        if(!vals[0]==""){            
            $(".ul_ones").css("marginTop",-parseInt($(".ul_ones li:contains('"+vals[0]+"年')").index() * lih));
            $(".ul_twos").css("marginTop",-parseInt($(".ul_twos li:contains('"+vals[1]+"')").index() * lih));
            $(".ul_threes").css("marginTop",-parseInt($(".ul_threes li:contains('"+vals[2]+"日')").index() * lih));
        }
        ...
        if(!vals[0]==""){   
          $(".ul_ones").css("marginTop",-parseInt($(".ul_ones li:contains('"+vals[0]+"')").index() * lih));
          $(".ul_twos").css("marginTop",-parseInt($(".ul_twos li:contains('"+vals[1]+"')").index() * lih));
        }
      ...
      // }else{
      //   var indexs = $(".ul_ones li:contains("+vals[0]+")").index()
      //   var liHs = $(".ul_ones li").outerHeight(true)*indexs
      //   $(".ul_ones").css("marginTop",-liHs)
      //    console.log(liHs)
      // }
