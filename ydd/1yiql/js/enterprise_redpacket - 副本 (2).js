...
function saveRedpacketBtn(obj){
	...
	$(".numberOnes",$(".classs_show")).each(function(){
		var that=parseFloat($(this).val());
		if(that >= $(".numberTwos",$(".classs_show")).val()){
	...
	$(".limit_sizes",$(".classs_show")).each(function(){
		...
		if(that == "" || parseFloat($(".limit_sizes",$(".classs_show")).val()) == 0){
			$(this).addClass("info_borders_red");
		}
		if(that > 3000){
			$(this).addClass("info_borders_red");
	...
	$(".more_than_rero",$(".classs_show")).each(function(){
		var that=parseFloat($(this).val());
		if(parseFloat(that) == 0 || $(".more_than_rero",$(".classs_show")).val() == ""){
			$(this).addClass("info_borders_red");
		}
		that = null;
	})
